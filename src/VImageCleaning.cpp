...
//
// produce a trigger map for calculation of  binary-image Hillas parameters and apply some sort of cleaning algorithm to reject noisy pixels
//
void VImageCleaning::cleanTriggerFixed( VImageCleaningRunParameter* iImageCleaningParameters )
{
    ///////////////////////////////////////////////
    // setting of image cleaning run parameters
    if( !iImageCleaningParameters )
    ...
    {
        vector< bool > tmp_trigger( fData->getNChannels(), 0 );
