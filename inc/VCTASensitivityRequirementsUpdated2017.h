// VCTASensitivityRequirementsUpdated2017 sensitivity requirements for CTA
//
//
// updated requirements March/April 2017
// added subsystem requirements
//
// values are hardwired

#ifndef VCTASensitivityRequirementsUpdated2017_H
#define VCTASensitivityRequirementsUpdated2017_H

#include <cmath>

class VCTASensitivityRequirementsUpdated2017
{
    private:
    ...
    public:
        ...
        VCTASensitivityRequirementsUpdated2017();
        ...
        {
            return 2.24 * pow( x / 480., 1.50 ) +
                   0.079 * pow( 0.013 / x, 1.3 ) +
                   0.0030 * pow( x, -0.071 ) +
                   0.08 * pow( 0.021 / x, 6. ) +
                   0.04 * pow( 0.016 / x, 14. ) +
                   0.02 * pow( 0.016 / x, 18. );
