...
Reconstruction and analysis can be complex; it requires inputs from different sources and execution of several independent stages.
...
- for **VERITAS** (converter to GADF DL3 Format): [https://github.com/VERITAS-Observatory/V2DL3](https://github.com/VERITAS-Observatory/V2DL3)
