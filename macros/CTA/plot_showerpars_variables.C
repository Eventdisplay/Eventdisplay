...
void plot_showerpars_variables( string iFile, bool iNorth = false )
{
    ...
    string fCut = "NImages[REPL]>1&&Chi2[REPL]>=0.&&sqrt( (MCxoff-Xoff[REPL])*(MCxoff-Xoff[REPL]) + (MCyoff-Yoff[REPL])*(MCyoff-Yoff[REPL]) )<2.&&sqrt( Xcore[REPL]* Xcore[REPL] + Ycore[REPL]*Ycore[REPL])<4.e3";
