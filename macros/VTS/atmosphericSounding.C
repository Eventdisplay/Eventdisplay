...
void plot_seasons( string iDataFile, bool iMonthly = false )
{
    ...
    year.push_back( 2014 );  month.push_back( 9 ); day.push_back( 8 );
    year.push_back( 2015 );  month.push_back( 9 ); day.push_back( 27 ); 
    year.push_back( 2016 );  month.push_back( 9 ); day.push_back( 16 );
    year.push_back( 2017 );  month.push_back( 9 ); day.push_back( 6 ); 
    year.push_back( 2018 );  month.push_back( 9 ); day.push_back( 2 );
