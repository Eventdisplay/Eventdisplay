void plotQualityCuts( string iMSCWFile, string iEnergy = "MCe0" )
{
     ...
     vector< string > iCut;
     iCutName.push_back( "noCut" );   iCut.push_back( "" );
     iCutName.push_back( "XYcut" );    iCut.push_back( "(Xoff*Xoff+Yoff*Yoff)<2.*2." );
     iCutName.push_back( "Chi2" );    iCut.push_back( "Chi2>=0." );
     iCutName.push_back( "NImages" );    iCut.push_back( "NImages>1" );
     iCutName.push_back( "MSC" );    iCut.push_back( "MSCW>-50.&&MSCL>-50." );
     iCutName.push_back( "EChi2" );    iCut.push_back( "EChi2S>=0.&&EChi2S<=99999" );
     iCutName.push_back( "dES" );    iCut.push_back( "dES>-99&dES<1e+12" );
     iCutName.push_back( "ErecS" );    iCut.push_back( "ErecS>0.&&ErecS<1.e10" );
     iCutName.push_back( "Size" );    iCut.push_back( "SizeSecondMax>200.");
