...
MCOPT=" -runnumber=$RUNNUM -sourcetype=2 -epoch $EPOCH -camera=$CFG -reconstructionparameter $ACUTS -sourcefile $VBF_FILE -deadchannelfile $DEAD -donotusedbinfo -calibrationdirectory $ODIR -teltoana=1 -ntel=1"
